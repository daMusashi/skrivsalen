...
ns.Modal.prototype.showInfo = function(titel, content){
	titel = titel || false;
...
ns.Modal.prototype.showWarning = function(titel, content){
	titel = titel || false;
...
ns.Modal.prototype.showError = function(titel, content){
	titel = titel || false;
...
ns.Modal.prototype.showUnkownError = function(titel, errorEvent){
	titel = titel || false;
...
ns.Modal.prototype._addModalToPage = function(){
	this.container.innerHTML = "";
	this.container.appendChild(this.DOM);
}

ns.Modal.prototype._addHeader = function(titel){
...
ns.Modal.prototype._addBody = function(content){
...
ns.Modal.prototype._addFooter = function(okLabel, cancelButton, cancelLabel){
	okLabel = okLabel || "Ok";
